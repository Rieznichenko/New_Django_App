...
class Logger:
    def __init__(self, task):
        ...
        if self.task and self.task.pk:
            ...
            self.cursor.execute('INSERT INTO urd_log (execution_time, task_id, run_id) values (%s, %s, %s) RETURNING id', (execution_time, self.task.pk, str(run_id)))
...
def worker(task: Task):
    ...
    while True:
        ...
        print("next time to schedule",time_to_next_execution.total_seconds())
